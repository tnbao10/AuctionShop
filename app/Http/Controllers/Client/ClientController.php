...
class ClientController extends Controller
{
    ...
    public function fashion(Request $request)
    {
        ...
        ->where('loaisanpham.lsp_ten','Thời trang')
        ->where('sp_ten','LIKE',$condition)
        ->where('hinhanhsanpham.hasp_anhdaidien',1)
        ->orderBy('dg_thoigianketthuc', 'desc')
        ->get();
        ...
        return view('client.product.fashion', compact('product'));
    }
    ...
    public function furniture(Request $request)
    {
        ...
        ->join('hinhanhsanpham','hinhanhsanpham.sp_id','sanpham.sp_id')
        ->join('loaisanpham','loaisanpham.lsp_id','sanpham.lsp_id')
        ->where('loaisanpham.lsp_ten','Nội thất')
        ->where('sp_ten','LIKE',$condition)
        ->where('hinhanhsanpham.hasp_anhdaidien',1)
        ->orderBy('dg_thoigianketthuc', 'desc')
        ->get();
        ...
        return view('client.product.furniture', compact('product'));
    }
    ...
    public function art(Request $request)
    {
        ...
        ->join('hinhanhsanpham','hinhanhsanpham.sp_id','sanpham.sp_id')
        ->join('loaisanpham','loaisanpham.lsp_id','sanpham.lsp_id')
        ->where('loaisanpham.lsp_ten','Nghệ thuật')
        ->where('sp_ten','LIKE',$condition)
        ->where('hinhanhsanpham.hasp_anhdaidien',1)
        ->orderBy('dg_thoigianketthuc', 'desc')
        ->get();
        ...
        return view('client.product.art', compact('product'));
    }
}
