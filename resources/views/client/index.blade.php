...
<div class="slider__container slider--one bg__cat--3">
    <div class="slide__container slider__activation__wrap owl-carousel">
        ...
        <div style="background-image: url({{asset("client/images/banner/big-img/background1.jpg")}}); background-size: 100%" class="single__slide animation__style01 slider__fixed--height">
            <div class="container">
                <div class="row align-items__center">
                    <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                        <div class="slide">
                            <div class="slider__inner">
                                ...
                                <h1>{{substr($item->bv_tieude,0,21)}}</h1>
                                <div class="cr__btn">
                    ...
                    <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                        <div class="slide__thumb">
                            <img src="{{asset("client/images/banner/big-img/Banner22.jpg")}}" alt="slider images">
                        ...
                        <div class="category">
                            <div class="ht__cat__thumb">
                                <a href="{{ route('client.product.detail', ['id'=>$item->dg_id]) }}">
                                    <img src="{{asset($item->hasp_duongdan)}}" width="300" height="300" alt="product images">
                                </a>
                            </div>
