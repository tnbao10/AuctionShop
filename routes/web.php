...
Route::middleware(['autoGetPrice'])->group(function () {
    Route::prefix('/')->name('client.')->group(function () {
        ...
        Route::get('/fashion',[ClientController::class,'fashion'])->name('fashion');
        Route::get('/furniture',[ClientController::class,'furniture'])->name('furniture');
        Route::get('/art',[ClientController::class,'art'])->name('art');
    ...
    Route::view('/introduction', 'client/introduction'); //trang gioi thieu
    ...
    Route::prefix('/thanh-toan')->name('payment.')->group(function () {
        ...
        Route::group(['middleware' => 'checkSession'], function () {
            ...
            Route::prefix('/loai-san-pham')->name('type.')->group(function () { 
                ...
                Route::get('/xoa1/{id}', [TypeController::class, 'delete1'])->name('delete1');
            });
