        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="section__title--2 text-center">
                    <h2 class="title__line">SẢN PHẨM ĐANG Đ GIÁ</h2>
                        ...
                        <div class="category">
                            <div class="ht__cat__thumb">
                                <a href="{{ route('client.product.detail', ['id'=>$item->dg_id]) }}">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXldq5K0jVX8KjY8Gy86JLSZZd6qwV0oiuvAartwsl&s" width="290" height="385" alt="product images">
                                </a>
                            </div>
