                        ...
                        <nav class="main__menu__nav hidden-xs hidden-sm">
                            <ul class="main__menu clearfix">
                                ...
                                <li class="drop">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{route('client.fashion')}}">Thời trang </a>
                                           
                                        </li>
                                        <li>
                                            <a href="{{route('client.art')}}">Nghệ thuật </a>
                                           
                                        </li>
                                        <li><a href="{{route('client.furniture')}}">Nội thất</a></li>
                                    </ul>
                                ...
                                <li class="drop"><a href="{{URL::to('/introduction')}}">Giới thiệu</a></li>
                        ...
                        <div class="mobile-menu clearfix visible-xs visible-sm">
                            <nav id="mobile_dropdown">
                                <ul>
                                    ...
                                    <li><a href="{{URL::to('/introduction')}}">Giới thiệu</a></li>
                                    <li><a href="{{route('client.search')}}">Cuộc đấu giá</a>
                                        <ul>
                                            <li><a href="{{route('client.fashion')}}">Thời trang</a></li>
                                            <li><a href="{{route('client.art')}}">Nghệ thuật</a></li>
                                            <li><a href="{{route('client.furniture')}}">Nội thất</a></li>
                                        </ul>
                                    </li>
