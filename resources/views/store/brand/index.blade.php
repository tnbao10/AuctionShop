                  ...
                  <table id="brand" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $item->th_ten }}</td>
                            <td>
                                <a href="{{ route('brand.edit', ['id'=>$item->th_id]) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Chỉnh sửa</a>
                                <a href="{{ route('brand.delete', ['id'=>$item->th_id]) }}" class="btn btn-danger"><i class="far fa-trash-alt"></i> Xoá</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
