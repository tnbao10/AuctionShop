    ...
    Route::prefix('/thanh-toan')->name('payment.')->group(function () {
        ...
        Route::group(['middleware' => 'checkSession'], function () {
            ...
            Route::prefix('/cua-hang')->group(function () { 
                Route::get('/', [StoreController::class, 'storeDetail'])->name('store.detail'); //sàn đáu giá view (Info)
            ...
            Route::prefix('/don-hang')->name('order.')->group(function () {
                Route::get('/danh-sach-don-hang',  [OrderController::class, 'getList'])->name('getList'); //Danh sách đơn hàng (Info)
