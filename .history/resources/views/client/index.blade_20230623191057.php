                        ...
                        <div class="category">
                            <div class="ht__cat__thumb">
                                <a href="{{ route('client.product.detail') }}">
                                    <img src="https://product.hstatic.net/200000667005/product/o1cn01q3drjw1sqqoxakh6h___2211190852241-0-cib_dc252e850ea643bbb9612979ca514986_master.jpg" width="290" height="385" alt="product images">
                                </a>
                            </div>
                            <div class="fr__hover__info">
                                <ul class="product__action">
                                    <li><a href="{{route('client.product.detail') }}" data-tooltip="Bid Now"><i class="icon-heart icons"></i></a></li>

                                    <li><a href="{{route('client.product.detail') }}"><i class="fa fa-gavel"></i></a></li>

                                    <li><a href="{{route('client.product.detail') }}"><i class="fa fa-search"></i></a></li>
                                </ul></div>
                            <div class="fr__product__inner">
                                <h4><a href="{{ route('client.product.detail') }}">{{ $item->sp_ten }}</a></h4>
                                @if($item->isAuction)
