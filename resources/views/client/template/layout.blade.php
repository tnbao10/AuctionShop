                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer">
                                <h2 class="title__line--2">AUCTION TABLE</h2>
                                {{-- <img src={{asset('client/images/logo/logo-do-cocaybuado.png')}}> --}}
                                <div class="ft__details">
                                    <p>
                                        Mã số thuế: 0108055420 <br>
                                        Số giấy đăng ký hoạt động: 01/TP-ĐKHĐ do Sở tư pháp Thành phố Hà Nội Cấp ngày 07/08/2017 <br>
                                        Địa chỉ: <br>
                                        Điện thoại: 024.32.115.234 <br>
                                        Email: auctiontable.vn
                                    </p>
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 xmt-40">
                            <div class="footer">
                                ...
                                <div class="ft__inner">
                                    <ul class="ft__list">
                                        <li><a href="{{URL::to('/introduction')}}">Về chúng tôi</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 xmt-40 smt-40">
                            <div class="footer">
                                ...
                                <br>
                                <br>
                                <img src={{asset('client/images/logo/dadangky.png')}}>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Footer Widget -->
